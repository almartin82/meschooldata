...
Python wrapper for Maine school enrollment data.

This is a thin rpy2 wrapper around the [meschooldata](https://github.com/almartin82/meschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `meschooldata` R package installed
...
df_multi = me.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
