...
class TestImport:
    ...
    def test_import_functions(self):
        ...
        import pymeschooldata as me
        assert hasattr(me, 'fetch_enr')
        assert hasattr(me, 'fetch_enr_multi')
        assert hasattr(me, 'tidy_enr')
        assert hasattr(me, 'get_available_years')

    def test_version_exists(self):
        """Package has a version string."""
        import pymeschooldata as me
        assert hasattr(me, '__version__')
        assert isinstance(me.__version__, str)
    ...
    def test_total_enrollment_reasonable(self):
        ...
        if 'is_district' in df.columns and 'grade_level' in df.columns:
            ...
            if len(total_df) > 0:
                ...
                # Maine should have ~180,000 students
...
class TestFetchEnrMulti:
    ...
    def test_returns_dataframe(self):
        """Returns a pandas DataFrame."""
        import pymeschooldata as me
        df = me.fetch_enr_multi([2023, 2024])
        assert isinstance(df, pd.DataFrame)
    ...
    def test_more_rows_than_single_year(self):
        ...
        import pymeschooldata as me
        df_single = me.fetch_enr(2024)
        df_multi = me.fetch_enr_multi([2023, 2024])
...
class TestDataIntegrity:
    ...
    def test_consistent_between_single_and_multi(self):
        ...
        import pymeschooldata as me
        df_single = me.fetch_enr(2024)
        df_multi = me.fetch_enr_multi([2024])
    ...
    def test_years_within_available_range(self):
        ...
        df = me.fetch_enr(years['max_year'])
        assert len(df) > 0
